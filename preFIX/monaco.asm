...
CH_LINE     = 27                 ; linea di mezzeria
CH_GRASS2   = 92                ; ciuffi d'erba (char 2 + 64)
CH_GRAVEL   = 29                 ; ghiaia (puntini su asfalto)
...
in_cc   lda $d000,x
        ...
        ; tile personalizzate: 1=mezzeria, 2=ciuffi, 3=ghiaia
        ldx #23
